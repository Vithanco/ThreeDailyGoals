...
public let secToday = TaskSection(text: "Today's Goals", image: imgPriority)
public let secOpen = TaskSection(text: "Open", image: imgOpen)
public let secClosed = TaskSection(text: "Closed", image: imgClosed)
public let secGraveyard = TaskSection(text: "Graveyard", image: imgGraveyard)
public let secPending = TaskSection(text: "Pending Response", image: imgPendingResponse)
public let secDueSoon = TaskSection(text: "Due Soon", image: imgDueSoon)
