...
extension TimeProvider {
    ...
    func getCompassCheckInterval(forDate: Date) -> DateInterval {
    ...
    func getCompassCheckInterval() -> DateInterval {
...
struct MockTimeProvider: TimeProvider {
    ...
    init(fixedNow: Date, calendar: Calendar = Calendar.current) {
        self.fixedNow = fixedNow
        self.testCalendar = calendar
    }
    
    var now: Date { fixedNow }
    var calendar: Calendar { testCalendar }
}

// MARK: - TimeProviderWrapper for SwiftUI Environment
@MainActor
@Observable
class TimeProviderWrapper {
    let timeProvider: TimeProvider
    
    init(_ timeProvider: TimeProvider) {
