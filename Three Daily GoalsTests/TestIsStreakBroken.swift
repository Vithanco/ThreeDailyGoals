...
struct TestIsStreakBroken {
    ...
    private func getTestComponents() -> (preferences: CloudPreferences, timeProvider: MockTimeProvider) {
        ...
        return (preferences, timeProvider)
    }
    ...
    func testIsStreakActive_AfternoonTime_WhenLastCheckIsTodayMorning_ReturnsTrue() throws {
        ...
        let afternoonTimeProvider = MockTimeProvider(
            fixedNow: realTimeProvider.date(
                from: DateComponents(year: 2025, month: 1, day: 15, hour: 14, minute: 0, second: 0))!)
        ...
        let thisMorning = afternoonTimeProvider.calendar.date(
            bySettingHour: 9, minute: 0, second: 0, of: afternoonTimeProvider.now)!
        ...
        #expect(
            result,
            "isStreakActive should be true when last check was this morning, since it's within the previous interval")
    }
    ...
    func testIsStreakActive_AfternoonTime_WhenLastCheckIsYesterdayAfternoon_ReturnsTrue() throws {
        ...
        let yesterdayAfternoon = afternoonTimeProvider.calendar.date(
            bySettingHour: 15, minute: 0, second: 0, of: yesterday)!
        ...
        #expect(
            result,
            "isStreakActive should be true when last check was yesterday afternoon, even when checking in afternoon")
    }
    ...
    func testIsStreakActive_AfternoonTime_WhenLastCheckIsTwoDaysAgo_ReturnsFalse() throws {
        ...
        let twoDaysAgoMorning = afternoonTimeProvider.calendar.date(
            bySettingHour: 10, minute: 0, second: 0, of: twoDaysAgo)!
        ...
        #expect(
            !result, "isStreakActive should be false when last check was two days ago, even when checking in afternoon")
    }
    ...
    func testIsStreakActive_AfternoonTime_WhenLastCheckIsJustBeforeNoonToday_ReturnsTrue() throws {
        ...
        #expect(
            result,
            "isStreakActive should be true when last check was just before noon today, even when checking in afternoon")
    }
    ...
    func testIsStreakActive_AfternoonTime_WhenLastCheckIsExactlyAtNoonToday_ReturnsTrue() throws {
        ...
        #expect(
            result,
            "isStreakActive should be true when last check was exactly at noon today, even when checking in afternoon")
    }
    ...
    func testIsStreakActive_AfternoonTime_WhenLastCheckIsJustAfterNoonToday_ReturnsTrue() throws {
        ...
        #expect(
            result,
            "isStreakActive should be true when last check was just after noon today, even when checking in afternoon")
    }
    ...
    func testIsStreakActive_AfternoonTime_WhenLastCheckIsYesterdayMorning_ReturnsFalse() throws {
        ...
        let yesterday = afternoonTimeProvider.getDate(daysPrior: 1)
        let yesterdayMorning = afternoonTimeProvider.calendar.date(
            bySettingHour: 8, minute: 0, second: 0, of: yesterday)!
        ...
        #expect(
            !result,
            "isStreakActive should be false when last check was yesterday morning, since it's before the previous interval"
        )
    }
    ...
    func testIsStreakActive_AfternoonTime_WhenLastCheckIsYesterdayEvening_ReturnsTrue() throws {
        ...
        let yesterday = afternoonTimeProvider.getDate(daysPrior: 1)
        let yesterdayEvening = afternoonTimeProvider.calendar.date(
        ...
        #expect(
            result,
            "isStreakActive should be true when last check was yesterday evening, even when checking in afternoon")
    }
}
