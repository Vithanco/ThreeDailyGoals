...
struct TestCompassCheckFlexibility {
    ...
    struct CustomTestStep: @MainActor CompassCheckStep {
    ...
    struct AlwaysSkipStep: @MainActor CompassCheckStep {
        var description: String = ""
    ...
    func testCustomStepInjection() throws {
        ...
        let appComponents = setupApp(
            isTesting: true, loaderForTests: createTestDataLoader(), compassCheckSteps: customSteps)
    ...
    func testStepSkippingBehavior() throws {
        ...
        let appComponents = setupApp(
            isTesting: true, loaderForTests: createTestDataLoader(), compassCheckSteps: stepsWithSkip)
        let compassCheckManager = appComponents.compassCheckManager
    ...
    func testMinimalStepConfiguration() throws {
        ...
        let appComponents = setupApp(
            isTesting: true, loaderForTests: createTestDataLoader(), compassCheckSteps: minimalSteps)
        let compassCheckManager = appComponents.compassCheckManager
    ...
    func testStepOrderingFlexibility() throws {
        ...
        let appComponents = setupApp(
            ...
            preferences: createTestPreferencesWithPlanEnabled(), compassCheckSteps: reorderedSteps)
        let compassCheckManager = appComponents.compassCheckManager
