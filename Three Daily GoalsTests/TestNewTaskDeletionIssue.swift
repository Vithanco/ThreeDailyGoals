...
struct TestNewTaskDeletionIssue {
    ...
    func testNewTaskGetsDeletedWhenUnchanged() throws {
        ...
        let appComponents = setupApp(isTesting: true, loader: emptyTestDataLoader)
        ...
        #expect(dataManager.items.count == initialCount + 1, "Task count should increase")
        ...
        #expect(dataManager.items.count == initialCount, "Task count should return to initial")
